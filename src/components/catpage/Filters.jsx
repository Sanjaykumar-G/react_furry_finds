  ...
  return (
    <aside className="filters">
      ...
      <div className="filter-category">
        <h3>Categories</h3>
        <ul>
          <li><input type="checkbox" /> Persian (2821)</li>
          <li><input type="checkbox" /> Siamese (1921)</li>
          <li><input type="checkbox" /> Maine Coon (1420)</li>
          <li><input type="checkbox" /> Bengal (1020)</li>
          <li><input type="checkbox" /> Sphynx (897)</li>
          <li><input type="checkbox" /> Ragdoll (650)</li>
          <li><input type="checkbox" /> British Shorthair (410)</li>
          <li><input type="checkbox" /> Scottish Fold (320)</li>
          <li><input type="checkbox" /> Abyssinian (210)</li>
        </ul>
      </div>
