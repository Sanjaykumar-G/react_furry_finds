...
import iImage1 from '../../assets/dogtoy1.webp'; // Import images
import iImage2 from '../../assets/dogtoy2.jpg'; // Import images
import Image3 from '../../assets/dogtoy3.jpg'; // Import images
import Image4 from '../../assets/dogtoy4.jpg'; // Import images
import Image5 from '../../assets/dogtoy5.jpg'; // Import images
import Image6 from '../../assets/dogtoy6.jpg'; // Import images
import Image7 from '../../assets/dogtoy7.jpg'; // Import images
import Image8 from '../../assets/dogtoy8.jpg'; // Import images
...
import './PetToysListPage.css'; // Import CSS

const PetFoodsListPage = () => {
  const navigate = useNavigate(); // Initialize useNavigate
  const [petFoods, setPetFoods] = useState([
    { id: 1, name: 'GiGwi Dinoball Edge with Strap', price: 50, discountPrice: 40, rating: 4.5, brand: 'Brand A', petType: 'dog', image: iImage1 },
    { id: 2, name: 'Trixie Capri 2 Cat & Dog Carrier / Transport Box - Medium (Up to 8kg)', price: 50, discountPrice: 40, rating: 4.5, brand: 'Brand A', petType: 'dog', image: iImage2 },
    { id: 3, name: 'FOFOS Pet Backpack Carrier For Small Cats & Dogs - Grey', price: 30, discountPrice: 20, rating: 4.5, brand: 'Brand A', petType: 'dog', image: Image3 },
    { id: 4, name: 'Trixie Bottle with Bowl - Stainless Steel/Plastic (300 ml)', price: 70, discountPrice: 40, rating: 4.5, brand: 'Brand A', petType: 'dog', image: Image4 },
    { id: 5, name: 'M-Pets Flow Crate For Cats & Dogs', price: 30, discountPrice: 10, rating: 4.5, brand: 'Brand A', petType: 'dog', image: Image5 },
    { id: 6, name: 'Trixie Dan Backpack Pet Carriern', price: 20, discountPrice: 10, rating: 4.5, brand: 'Brand A', petType: 'dog', image: Image6 },
    { id: 7, name: 'FOFOS Expandable & Foldable Pet Carrier For Cats & Dogs - Grey)', price: 20, discountPrice: 10, rating: 4.5, brand: 'Brand A', petType: 'dog', image: Image7 },
    { id: 8, name: 'Savic Trotter 3 Pet Carrier - Holds up to 10kg', price: 20, discountPrice: 10, rating: 4.5, brand: 'Brand A', petType: 'dog', image: Image8 },
  ...
  return (
    <div className="pet-foods-list-page">
      ...
      <h1 className="pet-foods-page-title">Pet Accessories</h1>
